...
from few.trajectory.ode.pn5 import dedt8H_5PNe10, dpdt8H_5PNe10, dYdt8H_5PNe10
from few.utils.baseclasses import ParallelModuleBase, Pn5AAK
from few.utils.geodesic import get_fundamental_frequencies, get_separatrix
from few.utils.mappings.pn import Y_to_xI
...
class PN5AddPhys(ODEBase):
    def evaluate_rhs(self, p, e, Y, Phi_phi, Phi_theta, Phi_r):
        ...
        pdot = dpdt8H_5PNe10(self.a, p, e, Y, 10, 10) * (1.0 + phys_factor1)
        edot = dedt8H_5PNe10(self.a, p, e, Y, 10, 8) * (1.0 + phys_factor1)
...
class pn5_add_phys_AAK(AAKWaveformBase, Pn5AAK, ParallelModuleBase):
    def __init__(self, *args, inspiral_kwargs={}, **kwargs):
        ...
        AAKWaveformBase.__init__(
            self, EMRIInspiral, AAKSummation, inspiral_kwargs=inspiral_kwargs, **kwargs
        )
...
phys_factor1 = 0.0
phys_factor2 = 0.0
t1, p1, e1, Y1, pp1, pt1, pr1 = add_phys_traj(
    M, mu, a, p0, e0, Y0, phys_factor1, phys_factor2
)

# run with strong effect
phys_factor1 = 1e-1
phys_factor2 = 1e-1
t2, p2, e2, Y2, pp2, pt2, pr2 = add_phys_traj(
    M, mu, a, p0, e0, Y0, phys_factor1, phys_factor2
)
...
logger.info(f"Mismatch: {get_mismatch(h1, h2)}")
